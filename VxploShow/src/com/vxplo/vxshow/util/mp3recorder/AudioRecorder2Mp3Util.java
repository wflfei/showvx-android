package com.vxplo.vxshow.util.mp3recorder;
...
import com.vxplo.vxshow.activity.RecordActivity.ConvertCompleteCallBack;
...
public class AudioRecorder2Mp3Util {
	...
	private ConvertCompleteCallBack callback;
	/**
	...
	public TransAsyncTask transTask;
	...
	public AudioRecorder2Mp3Util(Activity activity, String rawPath,
			String mp3Path, ConvertCompleteCallBack callback) {
		this.activity = activity;
		this.rawPath = rawPath;
		this.mp3Path = mp3Path;
		this.callback = callback;
		audioFormat = PCMFormat.PCM_16BIT;
		transTask = new TransAsyncTask();
	}
	...
	private void initAudioRecorder() throws IOException {
		...
		int frameSize = AudioRecord.getMinBufferSize(SAMPLE_RATE,
				AudioFormat.CHANNEL_IN_MONO, audioFormat.getAudioFormat()) / bytesPerFrame;
		...
		mRecorder = new AudioRecord(MediaRecorder.AudioSource.MIC,
				SAMPLE_RATE, AudioFormat.CHANNEL_IN_MONO, audioFormat.getAudioFormat(),
				bufferSize);
	}
	...
	public class TransAsyncTask extends AsyncTask<String, Integer, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			lameUtils.raw2mp3(rawPath, mp3Path);
		...
		void start() {
			...
			if (util == null)
				util = new AudioRecorder2Mp3Util(null, "/sdcard/sample.raw",
						"/sdcard/sample.mp3", new ConvertCompleteCallBack() {
